...
public class AddDropRingTab extends AbstractTab {
	...
	FXMLLoader loader = new FXMLLoader(Object.class.getClass().getResource("/phoenixSim/fxmls/tabs/add_drop_ring.fxml")) ; ;
	...
	public AddDropRingTabController getController(){
		return controller ;
	}
