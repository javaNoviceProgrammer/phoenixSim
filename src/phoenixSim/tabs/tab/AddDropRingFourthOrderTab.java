...
import phoenixSim.tabs.controller.AddDropRingFourthOrderTabController;
...
public class AddDropRingFourthOrderTab extends AbstractTab {
	...
	public AddDropRingFourthOrderTabController getController(){
		return controller ;
	}
