...
import phoenixSim.tabs.controller.DownSamplingTabController;
...
public class DownSamplingTab extends AbstractTab {
	...
	public DownSamplingTabController getController(){
		return controller ;
	}
