...
public class TriggerConversionGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TriggerConversionGUI frame = new TriggerConversionGUI(null);
	 ...
	 * Create the frame.
	 */
	public TriggerConversionGUI(SimulationDataBase simDataBase) {
		if(simDataBase == null)
			...
			public void actionPerformed(ActionEvent e) {
				if(!dbBox.isSelected()) {
					...
					if(simDataBase != null) {
						...
						simDataBase.addNewVariable(new SimulationVariable("voltage_(V)", "PD voltage (V)", wt.lightConverted));
//						simDataBase.addNewVariable(new SimulationVariable("Time_(sec)", "Time (sec)", wt.timeConverted));
					}
				}
				else {
					fig.clear();
					...
					if(simDataBase != null) {
						simDataBase.addNewVariable(new SimulationVariable("lambda_(nm)", "Wavelength (nm)", wt.lambdaNm));
						simDataBase.addNewVariable(new SimulationVariable("power_(dBm)", "Optical power (dBm)", lightConvertedDB));
//						simDataBase.addNewVariable(new SimulationVariable("Time_(sec)", "Time (sec)", wt.timeConverted));
					}
				}
			}
